  ...
  return (
    <PopupOverlay $isVisible={isVisible} onClick={handleOverlayClick}>
      <PopupContent onClick={(e) => e.stopPropagation()}>
        ...
        <Subtitle>You Minted BurrowBorn</Subtitle>
        
        <Description>
          Welcome to the Hoods DAO! Your BurrowBorn NFT has been successfully minted 
          and is now part of your collection. This unique piece represents your 
          membership in our community.
        </Description>

        <NftImage>
          <img 
            src="/bb_main_title.png" 
            alt="BurrowBorn NFT" 
            onError={(e) => {
